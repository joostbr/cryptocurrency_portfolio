...
class Client(object):
    ...
    def get_historical_klines(self, symbol, interval, start_str, end_str=None):
        ...
        return self.get_historical_klines2(symbol=symbol, interval=interval, start_ts = start_ts, end_ts = end_ts)

    def get_historical_klines2(self, symbol, interval, start_ts=None, end_ts=None):
        output_data = []
